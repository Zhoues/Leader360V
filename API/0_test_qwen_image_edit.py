...
def main():
    ...
    parser.add_argument("--server", "-s", default="http://localhost:25548", help="Server URL")
    parser.add_argument("--height", type=int, default=384, help="Output image height")
    ...
    parser.add_argument("--guidance", type=float, default=1, help="Guidance scale")
